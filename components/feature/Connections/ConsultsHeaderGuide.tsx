...
import ConsultsGuideModal from './ConsultsGuideModal';
import { BookOpen } from 'lucide-react';

export default function ConsultsHeaderGuide() {
  ...
  return (
    <>
      <button
        ...
        title="Open interactive Video Consultations guide"
      >
        <BookOpen className="w-3.5 h-3.5 text-[#458B9E]" />
        <span>Page Guide</span>
      </button>

      <ConsultsGuideModal isOpen={isOpen} onClose={() => setIsOpen(false)} />
    </>
  );
}
