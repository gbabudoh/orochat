...
import NestGuideModal from './NestGuideModal';
import { BookOpen } from 'lucide-react';

export default function NestHeaderGuide() {
  ...
  return (
    <>
      <button
        ...
        title="Open interactive OroNest Workspace guide"
      >
        <BookOpen className="w-3.5 h-3.5 text-[#458B9E]" />
        <span>Page Guide</span>
      </button>

      <NestGuideModal isOpen={isOpen} onClose={() => setIsOpen(false)} />
    </>
  );
}
