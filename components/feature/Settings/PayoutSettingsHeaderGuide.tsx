...
import PayoutSettingsGuideModal from './PayoutSettingsGuideModal';
import { BookOpen } from 'lucide-react';

export default function PayoutSettingsHeaderGuide() {
  ...
  return (
    <>
      <button
        ...
        title="Open interactive Payment Setup guide"
      >
        <BookOpen className="w-3.5 h-3.5 text-[#458B9E]" />
        <span>Page Guide</span>
      </button>

      <PayoutSettingsGuideModal isOpen={isOpen} onClose={() => setIsOpen(false)} />
    </>
  );
}
